...
import '../filter/util/filter_util.dart';
...
class FilteredImageWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (cachedImageBytes == null) {
      return buildFilterFuture(filter, image, context);
    } else {
      return buildFilter(cachedImageBytes);
    }
  }

  Widget buildFilterFuture(Filter filter, img.Image image, BuildContext context) {
    return FutureBuilder<List<int>>(
      future: FilterUtils.applyFilter(image, filter, context),
